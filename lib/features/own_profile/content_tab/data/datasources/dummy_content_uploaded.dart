...
class HomeMockData {
  ...
  static final List<Publication> userSubmittedContent = [
    Publication(
      ...
      type: 'Laporan',
      filePath: 'https://example.com/files/ml-weather-prediction.pdf',
      videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
      publishedDate: DateTime.now().subtract(Duration(days: 30)),
      metadata: {
        'subject': 'Machine Learning',
        'keywords': ['machine learning', 'weather prediction', 'algorithms'],
        'pages': 45,
        'language': 'Indonesian'
      },
      readCount: 128,
    ...
    Publication(
      ...
      type: 'Artikel',
      filePath: 'https://example.com/files/social-media-mental-health.pdf',
      videoUrl: '',
      publishedDate: DateTime.now().subtract(Duration(days: 15)),
      metadata: {
        'subject': 'Psikologi Sosial',
        'keywords': ['sosial media', 'kesehatan mental', 'remaja'],
        'pages': 32,
        'language': 'Indonesian'
      },
      readCount: 234,
    ...
    Publication(
      ...
      type: 'Video',
      filePath: 'https://example.com/files/sorting-algorithms-big-data.pdf',
      videoUrl: 'https://www.youtube.com/watch?v=example2',
      publishedDate: DateTime.now().subtract(Duration(days: 7)),
      metadata: {
        'subject': 'Computer Science',
        'keywords': ['algoritma', 'sorting', 'big data'],
        'pages': 28,
        'language': 'Indonesian'
      },
      readCount: 89,
    ...
    Publication(
      ...
      type: 'Presentasi',
      filePath: 'https://example.com/files/blockchain-voting-system.pdf',
      videoUrl: '',
      publishedDate: DateTime.now().subtract(Duration(days: 45)),
      metadata: {
        'subject': 'Blockchain Technology',
        'keywords': ['blockchain', 'voting', 'smart contracts'],
        'pages': 38,
        'language': 'Indonesian'
      },
      readCount: 156,
    ...
    Publication(
      ...
      type: 'Review Article',
      filePath: 'https://example.com/files/sustainable-energy-smart-cities.pdf',
      videoUrl: 'https://www.youtube.com/watch?v=example3',
      publishedDate: DateTime.now().subtract(Duration(days: 60)),
      metadata: {
        'subject': 'Sustainable Energy',
        'keywords': ['energy', 'smart cities', 'sustainability'],
        'pages': 52,
        'language': 'Indonesian'
      },
      readCount: 278,
    ...
    Publication(
      ...
      type: 'Strategi',
      filePath: 'https://example.com/files/deep-learning-medical-diagnosis.pdf',
      videoUrl: '',
      publishedDate: DateTime.now().subtract(Duration(days: 90)),
      metadata: {
        'subject': 'Medical AI',
        'keywords': ['deep learning', 'medical diagnosis', 'CNN'],
        'pages': 67,
        'language': 'Indonesian'
      },
      readCount: 345,
    ...
    Publication(
      ...
      type: 'Thesis',
      filePath: 'https://example.com/files/iot-smart-agriculture.pdf',
      videoUrl: 'https://www.youtube.com/watch?v=example4',
      publishedDate: DateTime.now().subtract(Duration(days: 20)),
      metadata: {
        'subject': 'IoT Agriculture',
        'keywords': ['IoT', 'agriculture', 'smart farming'],
        'pages': 89,
        'language': 'Indonesian'
      },
      readCount: 192,
    ...
    Publication(
      ...
      type: 'Laporan',
      filePath: 'https://example.com/files/cybersecurity-digital-banking.pdf',
      videoUrl: '',
      publishedDate: DateTime.now().subtract(Duration(days: 35)),
      metadata: {
        'subject': 'Cybersecurity',
        'keywords': ['cybersecurity', 'digital banking', 'authentication'],
        'pages': 43,
        'language': 'Indonesian'
      },
      readCount: 167,
    ...
    Publication(
      ...
      type: 'Video',
      filePath: 'https://example.com/files/vr-education.pdf',
      videoUrl: 'https://www.youtube.com/watch?v=example5',
      publishedDate: DateTime.now().subtract(Duration(days: 12)),
      metadata: {
        'subject': 'Educational Technology',
        'keywords': ['VR', 'education', 'interactive learning'],
        'pages': 34,
        'language': 'Indonesian'
      },
      readCount: 98,
    ...
    Publication(
      ...
      type: 'Artikel',
      filePath: 'https://example.com/files/data-analytics-ecommerce.pdf',
      videoUrl: '',
      publishedDate: DateTime.now().subtract(Duration(days: 25)),
      metadata: {
        'subject': 'Data Analytics',
        'keywords': ['data analytics', 'e-commerce', 'personalization'],
        'pages': 41,
        'language': 'Indonesian'
      },
      readCount: 213,
    ...
    Publication(
      ...
      type: 'Presentasi',
      filePath: 'https://example.com/files/cloud-migration-enterprise.pdf',
      videoUrl: 'https://www.youtube.com/watch?v=example6',
      publishedDate: DateTime.now().subtract(Duration(days: 50)),
      metadata: {
        'subject': 'Cloud Computing',
        'keywords': ['cloud migration', 'enterprise', 'best practices'],
        'pages': 55,
        'language': 'Indonesian'
      },
      readCount: 145,
    ...
    Publication(
      ...
      filePath: 'https://example.com/files/ar-manufacturing.pdf',
      videoUrl: '',
      publishedDate: DateTime.now().subtract(Duration(days: 75)),
      metadata: {
        'subject': 'Augmented Reality',
        'keywords': ['AR', 'manufacturing', 'industry 4.0'],
        'pages': 63,
        'language': 'Indonesian'
      },
      readCount: 187,
  ...
  static final List<Publication> publications = [
    Publication(
      ...
      type: 'Model Pembelajaran',
      filePath: 'https://example.com/files/ai-healthcare.pdf',
